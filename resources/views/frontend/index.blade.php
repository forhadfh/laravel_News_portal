                            ...
                            <div class="secOne-smallItem">
                                <div class="secOne-smallImg">
                                    ...
                                    <h5 class="secOne_smallTitle">
                                        <a
                                            href="{{ url('news/details/' . $three->id . '/' . $three->news_title_slug) }}">{{ $three->news_title }}
                                        </a>
                                    </h5>
                                </div>
                            </div>
                                ...
                                <div class="sec-one-wrpp2">
                                    <div class="secOne-news">
                                        <div class="secOne-image2">
                                            <a
                                                href="{{ url('news/details/' . $nine->id . '/' . $nine->news_title_slug) }}"><img
                                                    class="lazyload" src="{{ asset($nine->image) }}"></a>
                                        </div>
                                        <h4 class="secOne-title2">
                                            <a
                                                href="{{ url('news/details/' . $nine->id . '/' . $nine->news_title_slug) }}">{{ $nine->news_title }}
                                            </a>
                                        </h4>
                            ...
                            @foreach ($newnewspost as $key => $newsitem)
                                <div class="tab-image tab-border">
                                    ...
                                    <h4 class="tab_hadding"><a
                                            href="{{ url('news/details/' . $newsitem->id . '/' . $newsitem->news_title_slug) }}">{{ Str::limit($newsitem->news_title, 45) }}</a>
                                    </h4>
                                </div>
                            @endforeach
                        ...
                        <div class="news-titletab">
                            ...
                            @foreach ($newspopular as $key => $newsitem)
                                <div class="tab-image tab-border">
                                    ...
                                    <a href=" " class="tab-icon"><i class="la la-play"></i></a>
                                    <h4 class="tab_hadding"><a
                                            href="{{ url('news/details/' . $newsitem->id . '/' . $newsitem->news_title_slug) }}">{{ str::limit($newsitem->news_title, 45) }}
                                        </a></h4>
                                </div>
                            @endforeach
                                ...
                                <div class="themesBazar-4 themesBazar-m2">
                                    <div class="sec-two-wrpp">
                                        ...
                                        <h5 class="sec-two-title">
                                            <a href=" ">Coaching centers to stay closed during SSC exams
                                            </a>
                                        </h5>
                                    </div>
                                </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-8">
                ...
                <h2 class="themesBazar_cat07"> <a href=" "> <i class="las la-align-justify"></i> NATIONAL
                    </a> </h2>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12">
                ...
                <h2 class="themesBazar_cat04"> <a href=" "> <i class="las la-align-justify"></i> POLITICS
                    </a> </h2>
