                ...
                <div class="col-lg-8 col-md-8">
                    <div class="post-nav">
                        <ul class="pager">
                            ...
                            <li><a href=" " title="previous"><i class="la la-backward" aria-hidden="true"></i>
                                </a></li>
                            <li><a href=" ">01</a></li>
                            <li class="active"><span class="active">02</span></li>
                            <li><a href=" ">03</a></li>
                            <li><a href=" ">04</a></li>
                            <li><a href=" " title="next"><i class="la la-forward" aria-hidden="true"></i>
                                </a></li>
...
#e1dfdf; border-radius: 5px;">
                    ...
                    <div class="author-social">
                        <a href="https://www.facebook.com//" target="_black" title="Facebook"><i
                                class="lab la-facebook-f"></i></a>
                        <a href="https://www.twitter.com//" target="_black" title="Twitter"><i
                                class="lab la-twitter"></i></a>
                        <a href="https://www.youtube.com//" target="_black" title="Youtube"><i
                                class="lab la-youtube"></i></a>
                        <a href="https://www.linkedin.com//" target="_black" title="Linkedin"><i
                                class="lab la-linkedin-in"></i></a>
                        <a href="https://www.instagram.com//" target="_black" title="Instagram"><i
                                class="lab la-instagram"></i></a>
                    </div>
                    <div class="author-details" style="text-align:justify">
                        Earlier, on Sunday morning, Prime Minister Sheikh Hasina along with her younger sister Sheikh
                        Rehana went to the Palace of Westminster to pay their last respect to the late Queen where the
                        body of Elizabeth II was kept in the Lying-in-State. </div>
                </div>
