    ...
    <div class="row">
        <div class="col-lg-8 col-md-8">
            ...
            <div class="row g-2">
                <div class="col-lg-1 col-md-2 ">
                    <div class="reportar-image">
                        <img
                            src="{{ !empty($news->user->photo) ? url('upload/admin_images/' . $news->user->photo) : url('upload/no_image.jpg') }}">
                    </div>
                </div>
                <div class="col-lg-11 col-md-10">
                    <div class="reportar-title">

                        Posted By <a href="{{ route('reporter.all.news', $news->user_id) }}">{{ $news['user']['name'] }}
                        </a>
                    </div>
            ...
            <div class="single-image">
                <a><img class="lazyload" src="{{ asset($news->image) }}"></a>
            ...
            {{-- Comments --}}
            @guest
                <p><b> For Add Product Review. You Need To Login First <a href="{{ route('login') }}"> Login
                            Page</a> </b>
                </p>
            @else
                            ...
                            @foreach ($newnewspost as $key => $newsitem)
                                <div class="archive-tabWrpp archiveTab-border">
                                    ...
                                    <h4 class="archiveTab_hadding"><a
                                            href="{{ url('news/details/' . $newsitem->id . '/' . $newsitem->news_title_slug) }}">{{ Str::limit($newsitem->news_title, 55) }}
                                        </a>
                                    </h4>
                        ...
                        <div class="archiveTab-sibearNews">
                            ...
                            @foreach ($newspopular as $key => $newsitem)
                                <div class="archive-tabWrpp archiveTab-border">
                                    ...
                                    <a href=" " class="archiveTab-icon2"><i class="la la-play"></i></a>
                                    <h4 class="archiveTab_hadding"><a
                                            href="{{ url('news/details/' . $newsitem->id . '/' . $newsitem->news_title_slug) }}">{{ Str::limit($newsitem->news_title, 55) }}</a>
                                    </h4>
                                    <div class="archive-conut">
                                        {{ $key + 1 }}
                                    </div>
