                            ...
                            <form id="myForm" method="post" action="{{ route('update.video.gallery') }}"
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6 mb-3">
                                        ...
                                        <input type="text" name="video_title" class="form-control" id="inputEmail4"
                                            value="{{ $video->video_title }}">
                                    </div>

                                    <div class="form-group col-md-6 mb-3">
                                        <label for="inputEmail4" class="form-label"> Video Url </label>
                                        <input type="text" name="video_url" class="form-control" id="inputEmail4"
                                    ...
                                    <div class="form-group col-md-6 mb-3">
                                        ...
                                        <img id="showImage" src="{{ asset($video->video_image) }} "
